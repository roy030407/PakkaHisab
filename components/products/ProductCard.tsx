...
export function ProductCard({
  ...
  return (
    <div className={`card-lift rounded-lg border p-4 shadow-sm transition-shadow hover:shadow-md ${
      highlighted ? 'border-emerald-300 bg-emerald-50/40 ring-1 ring-emerald-200' : 'border-gray-200 bg-white'
    }`}>
      {highlighted && (
        <span className="mb-2 inline-block rounded-full bg-emerald-100 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-emerald-700">
          Most sold
        </span>
      )}
